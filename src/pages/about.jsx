...
const About = () => {
  return (
    <section className="flex flex-col items-center justify-center py-10 px-5 md:px-20 mt-10 md:mt-0 bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white">
      {/* About Title */}
      <h2 className="text-4xl font-bold flex items-center gap-2 mb-20 mt-0 font-[ubuntu]">
        <span className="text-4xl">
          <img
            className="mr-0.5 -mb-0.7"
            width="32"
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-25 max-w-5xl relative z-10 md:-mr-30">
        ...
        <div className="flex-1 text-center md:text-left md:ml-6">
          <h3 className="text-2xl font-bold font-[Ubuntu] text-white">I'm Rishi T</h3>
          <p className="text-sm text-blue-300 font-bold font-[Ubuntu] mt-1 mb-3">
            Student | FullStack Developer
          </p>
          <p className="font-medium font-[Ubuntu] text-gray-300 mb-5 md:pr-20 text-justify">
            I'm Rishi, a passionate frontend and backend developer and a second-year student at Sri Sairam Engineering College. I am dedicated to continuous learning, pushing my limits, and creating seamless digital experiences. With a strong interest in web development, I focus on building intuitive and efficient solutions while actively participating in social initiatives that drive positive change.
          </p>

          {/* Personal Info */}
          <div className="text-gray-300 grid grid-cols-2 gap-2 mr-0 text-sm">
            <p>
              <span className="text-blue-400 font-bold font-[Ubuntu]">Age :</span>
              <span className="font-medium font-[Ubuntu] pl-1">19</span>
            </p>
            <p className="-ml-4"> 
              <span className="text-blue-400 font-bold font-[Ubuntu]">Email :</span>
              <span className="font-medium font-[Ubuntu] pl-1">rishithayanidhi@gmail.com</span>
            </p>
            <p>
              <span className="text-blue-400 font-bold font-[Ubuntu]">Phone :</span>
              <span className="font-medium font-[Ubuntu] pl-1">9884947313</span>
            </p>
            <p className="-ml-4"> 
              <span className="text-blue-400 font-bold font-[Ubuntu]">Place :</span>
              <span className="font-medium font-[Ubuntu] pl-1">Chennai, India</span>
            </p>
          </div>
          ...
          <div className="mt-5 w-full flex justify-center md:justify-start">
            ...
            >
              <button
                className="group cursor-pointer mt-6 bg-[#b3b300] text-white font-semibold py-3 px-8 rounded-lg transition-transform duration-300 transform hover:scale-105 hover:shadow-xl"
